...
def merge_all_data(user_health_data_csv,supplement_usage_csv,experiments_csv,user_profiles_csv) :

    #Extract
    # user_health_data.csv
    user_health_data = pd.read_csv(user_health_data_csv)
    
    #supplement_usage.csv
    supplement_usage = pd.read_csv(supplement_usage_csv)
...
merge_all_data('Supplement Experiments/data/user_health_data.csv', 'Supplement Experiments/data/supplement_usage.csv',
                'Supplement Experiments/data/experiments.csv','Supplement Experiments/data/user_profiles.csv')
